        ...
        <div className="grid gap-8 py-8 border-t sm:grid-cols-12 md:py-12 border-zinc-200">
          ...
          <div className="flex flex-col sm:col-span-6 md:col-span-2 lg:col-span-2 max-sm:order-1">
            ...
            <div className="text-sm text-zinc-500">
              <p>&copy; Chatvolt AI - All rights reserved.</p>
              <p>This software is based on the open-source project <a href="https://github.com/gmpetrov/databerry">Databerry (Chaindesk)</a></p>
              <p>Licensed under the <a href="https://www.gnu.org/licenses/agpl-3.0.html">AGPL-3.0</a>.</p>
            </div>
            {/* Social links */}
            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://www.chatvolt.ai/blog"
                    target="_blank"
                  >
                    Blog
                  </a>
