...
import { ChatboxEvent, CustomContact } from '@chatvolt/lib/types';
import { InitWidgetProps } from '@chatvolt/ui/embeds/types';
import { createTheme, createThemeKeys } from '@chatvolt/ui/themes/base';
...
const themePrefix = 'chatvolt-embeds';
