...
import type { Agent, Contact } from '@chatvolt/prisma';
...
import Motion from '@chatvolt/ui/Motion';
    ...
    <>
      {initMessages?.length > 0 &&
        ...
        !state.hasOpenOnce && (
          <Stack
            ref={initMessageRef}
            className="chatvolt-init-messages"
            sx={{
              position: 'fixed',
              bottom: 100,
