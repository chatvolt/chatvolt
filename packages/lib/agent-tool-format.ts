...
import { Datastore, Tool, ToolType } from '@chatvolt/prisma';
...
export const agentToolConfig = {
  ...
  [ToolType.http]: {
    icon: '🛜',
    title: '🛜 HTTP Tool',
    description: `Agent can perform an HTTP request to an external API (Compatible only with GPT 3.5 and GPT 4)`,
  },
  [ToolType.form]: {
    icon: '📋',
    title: '📋 Form',
    description: `Connect a form to your Agent (Compatible only with GPT 3.5 and GPT 4)`,
  },
