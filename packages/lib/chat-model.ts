...
export default class ChatModel {
  ...
  constructor(options?: ClientOptions) {
    this.openai = new OpenAI({
      ...options,
      defaultHeaders: {
        'HTTP-Referer': 'https://www.chatvolt.ai/', // Optional, for including your app on openrouter.ai rankings.
        'X-Title': 'Chatvolt', // Optional. Shows in rankings on openrouter.ai.
