...
const items: Product[] = [
  {
    ...
    metadata: {
      title:
        'AI Agent - Custom ChatGPT AI Chatbot for Your Website | Chatvolt',
    },
  ...
  },
  {
    ...
    metadata: {
      title: 'AI Form - Build GPT-Powered form in minutes | Chatvolt',
    },
    logo: '/images/logo.png',
    cta: {
      label: 'Get Started for Free',
      url: 'https://app.chatvolt.ai/forms',
    },
      ...
      items: [
        {
          name: 'Form Setup',
          description:
            "Use Chatvolt's form builder to configure your form. Give your AI a persona and add fields for data you want to collect.",
        },
        {
          name: 'Publish',
          description:
        ...
        {
          name: 'Connect your form to a Chatvolt AI Agent',
          description:
            'Optionally, AI Forms can be connected to a Chatvolt AI Agent to enhance their capabilities.',
        },
      ],
    },
  },
  {
    ...
    metadata: {
      title: 'Email Support - Automate Your Email Support with AI | Chatvolt',
    },
    logo: '/images/logo.png',
    icon: (props: any) => {
      return (
      ...
      items: [
        {
          ...
          description:
            'Configure Chatvolt to receive and send emails on your behalf - get started in less than 2 minutes.',
        },
        {
          name: 'AI-powered email replies',
          description:
            "Chatvolt's AI will learn - not only from your knowledge base - but from all your previous email conversations.",
        },
        {
...

  {
    ...
    metadata: {
      title:
        'Shared Inbox - All your AI chatbot conversations in one place | Chatvolt',
      description: '',
    },
    logo: '/images/logo.png',
    icon: (props: any) => (
