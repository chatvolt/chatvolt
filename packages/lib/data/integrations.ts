...
const items: Product[] = [
  // Channels
  {
    ...
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for Your Website | Chatvolt',
    },
    logo: 'https://www.svgrepo.com/show/197996/internet.svg',
    cta: {
      label: 'Get Started for Free',
      url: 'https://app.chatvolt.ai/agents',
    },
  ...
  },
  {
    ...
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for WhatsApp Business | Chatvolt',
    },
    youtubeVideoId: '-NkVS2l66Zs',
    isComingSoon: false,
    isDatasource: false,
    ...
    features: {
      items: [
        ...
        },
        {
          ...
          description:
            'The final step is to install Chatvolt Bot to your WhatsApp Business account. \nNow your WhatsApp is spiced up \nwith some AI magic ✨',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  },
  {
    ...
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for Slack | Chatvolt',
    },
    ...
    features: {
      items: [
        ...
        },
        {
          ...
          description:
            'The final step is to install Chatvolt Bot to your Slack workspace. \nNow your workspace is spiced up \nwith some AI magic ✨',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  },
  {
    ...
    cta: {
      label: 'Get Started for Free',
      url: 'https://app.chatvolt.ai/datastores',
    },
    ...
    metadata: {
      title:
        'Custom ChatGPT - AI Chatbot for Crisp - Automate Your Support | Chatvolt',
    },
    features: {
      items: [
        {
  ...
  },
  {
    slug: 'zapier',
    name: 'Zapier',
    title: 'Connect Chatvolt with Anything via Zapier',
    description:
      'Connect Chatvolt with over 5,000 apps via Zapier. Train your chatbot in minutes, integrate it seamlessly on your site, and keep your data always in sync.',
    ...
    isChannel: true,
    metadata: {
      title: 'Chatvolt & Zapier: Seamless Integration with 5,000+ Apps',
    },
    features: {
      items: [
        {
        ...
        },
        {
          name: 'Zapier Setup',
          description:
            'Create your Zapier worflow and connect Chatvolt with over 5,000 apps.',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  },
  {
    ...
    description:
      'Train a chatbot with your data on Chatvolt platform. Install the Wordpress plugin! Stay updated with auto-sync.',
    ...
    isChannel: true,
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for Wordpress | Chatvolt',
    },
    features: {
      items: [
        {
        ...
        },
        {
          ...
          description:
            'The final step is to link your Wordpress website to your Chatvolt Agent via our plugin. Just install the plugin and follow the instructions.',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  },
  {
    ...
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for Shopify | Chatvolt',
      description: ``,
    },
    youtubeVideoId: '-NkVS2l66Zs',
    isComingSoon: false,
    ...
    features: {
      items: [
        ...
        },
        {
          ...
          description:
            'The final step is to install Chatvolt Bot to your Shopify store. \nNow your store is spiced up \nwith some AI magic ✨',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  },
  {
    ...
    metadata: {
      title: 'Custom ChatGPT - AI Chatbot for Telegram | Chatvolt',
      description: ``,
    },
    youtubeVideoId: 'eV7vbhskUaM',
    isComingSoon: true,
    ...
    features: {
      items: [
        ...
        },
        {
          ...
          description:
            'The final step is to install Chatvolt Bot to your Telegram. \nNow your workspace is spiced up \nwith some AI magic ✨',
        },
        {
          name: 'Auto Sync',
          description:
  ...
  // Datasources
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Website - AI Chatbot trained with your Website data',
    },
    youtubeVideoId: '-NkVS2l66Zs',
    logo: 'https://www.svgrepo.com/show/197996/internet.svg',
    cta: {
  ...
  },
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Notion - AI Chatbot trained with your Notion data',
    },
    isDatasource: true,
    features: {
      items: [
        {
          ...
          description:
            'Select the notebooks your want to import in Chatvolt. It takes just a few seconds.',
        },
        {
          name: 'Chat',
          description:
  ...
  },
  {
    ...
    description:
      'Chat with any Notion notebook using Chatvolt. Easily add a Notion notebook and start getting summaries or finding information.',
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Google Drive - AI Chatbot trained with your Google Drive data',
    },
  ...
  },
  {
    ...
    description:
      'Easily train your custom chatgpt chatbot any YouTube videos using Chatvolt.',
    ...
    metadata: {
      title:
        'Chatvolt Plugin: YoutTube - AI Chatbot trained with your YouTube videos',
    },
    youtubeVideoId: '-NkVS2l66Zs',
    isDatasource: true,
    features: {
  ...
  },
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Powerpoint - AI Chatbot trained with your Powerpoint documents',
    },
      ...
      items: [
        {
          name: 'Add your data',
          description:
            'Import your Powerpoint documents to Chatvolt. It takes just a few seconds.',
        },
        {
          name: 'Chat',
          description:
  ...
  },
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Word - AI Chatbot trained with your Word documents',
    },
    youtubeVideoId: '_n3VQM9N3-Q',
    isDatasource: true,
    features: {
      items: [
        {
          name: 'Add your data',
          description:
            'Import your Word documents to Chatvolt. It takes just a few seconds.',
        },
        {
          name: 'Chat',
          description:
  ...
  },
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: Excel - AI Chatbot trained with your Excel documents',
    },
    youtubeVideoId: '_n3VQM9N3-Q',
    isDatasource: true,
    features: {
      items: [
        {
          name: 'Add your data',
          description:
            'Import your Excel documents to Chatvolt. It takes just a few seconds.',
        },
        {
          name: 'Chat',
          description:
  ...
  },
  {
    ...
    metadata: {
      title:
        'Chatvolt Plugin: PDF Files - AI Chatbot trained with your PDF documents',
    },
    features: {
      items: [
        {
          ...
          description:
            'Import your PDF documents to Chatvolt. It takes just a few seconds.',
        },
        {
          name: 'Chat',
          description:
