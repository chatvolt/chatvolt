import type { ChatBoxStandardProps } from '@chatvolt/ui/ChatBoxLoader';

import setupAttributes from '@chatvolt/ui/embeds/common/setup-attributes';
import { hookFunctionsToWindow } from '@chatvolt/ui/embeds/common/utils';
