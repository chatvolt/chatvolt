      ...
      <div className="relative z-10">
        <div className="flex flex-col space-y-8 text-center sm:space-y-0 sm:flex-row sm:space-x-8 sm:text-left">
          <Stack sx={{ width: '100%' }}>
            ...
            <div className="flex flex-col mt-4 space-y-4">
              <div className="inline-flex items-center space-x-2">
                ...
                Desbloqueie o poder de uma IA segura treinada em seus dados.
                </p>
              </div>
              {/* <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
              ...
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                Precisão elevada, sem alucinações ou respostas forçadas.
                </p>
              </div>
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                Transição para atendimento humano de forma automática.
                </p>
              </div>
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                Integre facilmente em seu site ou WhatsApp.
                </p>
              </div>
              <div className="inline-flex items-center space-x-2">
                <CheckBadgeIcon className="w-5 h-5 text-green-400" />
                <p className="mx-auto max-w-md tracking-tight text-gray-200 text-md sm:text-xl sm:mx-0 sm:max-w-lg">
                Integrado nas +20 melhores LLMs da atualidade.
                </p>
              </div>
            </div>
          ...
          <p className="mx-auto mt-6 max-w-md text-lg tracking-tight text-gray-200 sm:mx-0 sm:max-w-lg">
              Com nossa {' '}
              <strong className="text-violet-300">plataforma no-code</strong>, você pode criar um {' '}
              <strong className="text-violet-300">
                Agente Autônomo de IA personalizado
              </strong>{' '}
                treinado em seus dados, em segundos.
            </p> 
...
*/}
          ...
          <div className="flex items-center w-full sm:w-2/3">
            <Image
              src="/landing-page-ptbr/inputs.png"
              width="800"
              height="509"
              className="w-full"
              alt="Datasources"
