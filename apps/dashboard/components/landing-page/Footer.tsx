...
const navigation = {
  ...
  support: [
    ...
    {
      name: 'GDPR',
      href: 'https://www.chatvolt.ai/help/gdpr',
      target: '_blank',
    },
    {
      name: 'Privacy',
      href: 'https://www.chatvolt.ai/help/privacy-policy',
      target: '_blank',
    },
    {
      name: 'Terms',
      href: 'https://www.chatvolt.ai/help/terms-conditions',
      target: '_blank',
    },
    // { name: 'Guides', href: '#' },
  ...
  social: [
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/chatvolt_ai',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="pt-8 mt-16 border-t border-white/10 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            Copyright &copy; {new Date().getFullYear()} Chatvolt - All rights
            reserved.
          </p>
        </div>
      </div>
