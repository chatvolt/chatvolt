...
export default function Navigation() {
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      if (
        window.location.hostname === 'app.chatvolt.ai' ||
    ...
    <Stack sx={{ height: '100%' }}>
              ...
              <script
                ...
                dangerouslySetInnerHTML={{
                  ...
                  Chatbox.initBubble({
                      ...
                      `)}',
                      interface: {
                        // iconUrl: 'https://www.chatvolt.ai/logo.png',
      ...
      <Stack gap={1}>
        <Stack direction="row" justifyContent={'center'} gap={1}>
          <Link href="https://twitter.com/chatvolt_ai" target="_blank">
        ...
        <Stack direction="row" sx={{ justifyContent: 'center', gap: 1 }}>
          ...
          {getStatusQuery?.data?.status && (
            <Link href={'https://status.chatvolt.ai/'} target={'_blank'}>
              <Chip
                color={
                  (
                    {
