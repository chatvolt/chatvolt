...
export default function Layout(props: Props) {
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      if (
        window.location.hostname === 'partner.chatvolt.ai' ||
        window.location.hostname === 'www.chatvolt.ai' ||
        window.location.hostname === 'chatvolt.ai'
      ) {
        window.location.href =
          'https://app.chatvolt.ai' + window.location.pathname;
      }
    }
  }, []);
  ...
  React.useEffect(() => {
    if (
      ...
      toast.error(
        "We're experiencing some issues. Check status.chatvolt.ai for more details. Sorry for the inconvenience!",
        {
          duration: 10000,
          id: 'status-error',
        }
  ...
  return (
    <>
      <SEO
        title="Dashboard | Chatvolt."
        description="Build your own AI ChatBot for your business."
        baseUrl={appUrl}
        uri={router.pathname}
      />
      {drawerOpen && (
      ...
      {showPromoBanner && (
        ...
        >
          ...
          Chatvolt has transformed the way we handle customer queries with its next-gen AI native solution. Definitely a game-changer!
          
          Find out more: https://www.chatvolt.ai`)}`}
              >
                <Button
                  color="neutral"
                  // variant="outlined"
              ...
              <a
                target="_blank"
                href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.chatvolt.ai`}
                className="w-full"
              >
                <Button
                  color="neutral"
      ...
      >
        ...
        >
          <Box
            component={'iframe'}
            // src={'https://app.chatvolt.ai/forms/clvssv7hy0099cppact2hgxx1'}
            src={'https://www.chatvolt.ai/agents/clvvsb34u000apb98ir5qrll6/iframe'}
            frameBorder="0"
            sx={{
              width: '100%',
              maxWidth: '100%',
