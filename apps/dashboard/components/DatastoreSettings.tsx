...
import getDatastoreS3Url from '@chatvolt/lib/get-datastore-s3-url';
import getRootDomain from '@chatvolt/lib/get-root-domain';
    ...
    <form onSubmit={methods.handleSubmit(handleUpdatePlugin)}>
      <Stack gap={2}>
        ...
        <FormControl>
          ...
          <Input
            control={methods.control as any}
            placeholder="e.g. Chatvolt is a no-code platform for building AI apps..."
      ...
      <FormControl sx={{ gap: 1 }}>
        <Stack spacing={2}>
          ...
          <Alert
            ...
            endDecorator={
              <Link href="https://docs.chatvolt.ai" target="_blank">
                <Button
                  variant="plain"
                  size="sm"
                  endDecorator={<ArrowForwardRoundedIcon />}
        ...
        {getDatastoreQuery?.data?.id && (
          <FormControl sx={{ gap: 1 }}>
            ...
            <Alert
              ...
              endDecorator={
                <Link
                  href="https://docs.chatvolt.ai/integrations/chatgpt-plugin"
                  target="_blank"
                >
                  <Button
                    variant="plain"
