    ...
    <Popover>
      ...
      <Transition.Root>
        ...
        >
          ...
          >
            <MobileNavLink href="/br/pricing">Planos e Preços</MobileNavLink>
            ...
            <MobileNavLink href={appUrl}>Entrar</MobileNavLink>
          </Popover.Panel>
        </Transition.Child>
      </Transition.Root>
    </Popover>
          ...
          <nav className="flex relative z-50 justify-between">
            <div className="flex items-center md:gap-x-12">
              ...
              <div className="hidden md:flex md:gap-x-6">
                ...
                <NavLink
                  href="https://pages.chatvolt.com.br/afiliados"
                  target={'_blank'}
                >
                  Afiliados
                </NavLink>
                <NavLink href="/br/#integrations">Integrações</NavLink>
                <NavLink href="/br/pricing">Planos e Preços</NavLink>
