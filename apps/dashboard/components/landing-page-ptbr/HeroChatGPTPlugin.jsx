      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col space-y-8 text-center sm:space-y-0 sm:flex-row sm:space-x-8 sm:text-left">
          <Stack sx={{ width: '100%' }}>
            ...
            {/* <a
          href="https://www.producthunt.com/posts/chatvolt-ai?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-chatvolt&#0045;ai"
          target="_blank"
        >
          <img
            src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=394302&theme=light"
            alt="Chatvolt&#0046;ai - Build&#0032;a&#0032;ChatGPT&#0032;plugin&#0032;in&#0032;minutes | Product Hunt"
            style={{
              width: '250px',
              height: '54px',
              marginLeft: 'auto',
          ...
          <div className="w-full sm:w-2/3">
            ...
            {/* <Image src="/landing-page-ptbr/outputs.png" width="500" height="150" className='w-full' /> */}
          </div>
        </div>
