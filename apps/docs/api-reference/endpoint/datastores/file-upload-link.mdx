...
api: 'POST https://api.chatvolt.ai/datastores/file-upload/generate-link/{datastoreId}'
...
curl --location --request POST 'https://api.chatvolt.ai/datastores/file-upload/generate-link/<datastoreId>' \
