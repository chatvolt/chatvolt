Integrate Google Drive with [Chatvolt.ai](http://chatvolt.ai/) to train AI agents using files or folders from your Drive.
Chatvolt syncs linked data automatically in order to keep your agent up-to-date.

<Note>
  💡 Chatvolt use and transfer of information received from Google APIs to any
