...
export async function generateMetadata(
  ...
  return {
    title: `${summary?.output?.metadata?.title} - AI YouTube Video Summary | Chatvolt`,
    description:
    ...
    } AI chatbot, No-code platform, AI Customer Support, Onboarding, Slack AI chatbot, Automation, Chatvolt, ChatGPT Plugin, Chat PDF, Chat with any document, Custom ChatGPT Bot, Chatbot GPT, Chatbot, ChatGPT Chatbot, WhatsApp ChatGPT Chatbot`,
  };
}
