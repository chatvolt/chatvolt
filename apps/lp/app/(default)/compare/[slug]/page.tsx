...
export async function generateMetadata(
  ...
  return {
    title: `${name} alternative - Chatvolt`,
    description: `Chatvolt is the #1 ${name} alternative that helps you create a custom ChatGPT AI chatbot without code in minutes. `,
    alternates: {
  ...
  return (
    <>
      <HeroProduct
        ...
        description={`Looking for a ${name} alternative? People switch from ${name} to Chatvolt because it looks better, comes with more widgets and customization and is much easier to use. Here’s why we think you should make the switch too ✨`}
        cta={{
      ...
      <FeatureV1
        label="Why Chatvolt?"
        title={`Chatvolt VS ${name}`}
        description="Chatvolt is an AI-powered ecosystem that helps you automate support and more. Here’s why you should make the switch to Chatvolt:"
        features={[
          {
            name: 'Native Integrations:',
            description:
              'Chatvolt allows you to import data from a wide range of sources, Notion, Google Drive, and more...',
            icon: CheckIcon,
          },
          {
            name: 'Auto-Sync Datasources:',
            description:
              'Chatvolt retrains your AI chatbot automatically when your data is updated.',
            icon: CheckIcon,
          },
          {
            name: 'Trustworthy, Secure and Focused:',
            description:
              'With built-in safeguards, Chatvolt strictly uses your support content to answer questions, eliminating off-topic conversations and misleading responses.',
            icon: CheckIcon,
          },
          {
          ...
          },
          {
            name: 'Human Handoff:',
            description:
              'With Chatvolt you can take over the conversation at any time, ensuring that your customers are always getting the best possible support.',
            icon: CheckIcon,
          },
          {
            name: 'Shared Inbox:',
          ...
          },
          {
            ...
            description:
              'Chatvolt AI Agents are able to resolve tickets automatically, when the user is satisfied with the answer. This reduces the workload of your support team.',
            icon: CheckIcon,
          },
          {
            name: 'Lead Generation:',
            description:
              'Chatvolt AI Agents are able to collect user information (email, phone number) in a conversational way.',
            icon: CheckIcon,
          },
          {
            name: 'Multilingual:',
            description:
              'With support for over 120 languages, Chatvolt chatbots can serve a global customer base, breaking down language barriers and facilitating seamless international customer service.',
            icon: CheckIcon,
          },
          {
            name: 'Near-zero learning curve:',
            description:
              'Chatvolt is designed to be easy to use, with a simple and intuitive interface that requires no technical knowledge to operate.',
            icon: CheckIcon,
          },
        ]}
      />
