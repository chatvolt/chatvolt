  ...
  return (
    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
      <div className="inline-flex relative px-3 py-1 space-x-2 text-sm leading-6 text-gray-600 rounded-full ring-1 ring-gray-900/10 hover:ring-gray-900/20">
        ...
        <span>Train a custom AI Assistant Chatbot on YouTube videos</span>
        <a
          href={`https://app.chatvolt.ai/agents?utm_source=landing_page&utm_medium=tool&utm_campaign=youtube_summarizer`}
