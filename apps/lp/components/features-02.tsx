        ...
        <div className="max-w-6xl px-4 mx-auto sm:px-6">
          <div className="relative max-w-3xl pb-12 mx-auto text-center md:pb-20">
            ...
            >
              <TextGenerateEffect
                duration={0.5}
                text={`Chatvolt leverages Generative AI models like GPT-4 to provide secure, precise responses, resolving customer inquiries and instantly reducing your team’s ticket volume.`}
              />
            </motion.p>
          </div>
          <motion.div
          ...
          >
            ...
            >
              <div className="flex flex-col p-5 pt-6 grow">
                ...
                <p className="max-w-md text-sm grow text-zinc-500">
                  Chatvolt ingests content seamlessly from various sources
            ...
            >
              <div className="flex flex-col p-5 pt-6 grow">
                ...
                <p className="max-w-md text-sm grow text-zinc-500">
                  With built-in safeguards, Chatvolt Agents provides precise
            ...
            >
              <div className="flex flex-col p-5 pt-6 grow">
                ...
                <p className="max-w-md text-sm grow text-zinc-500">
                  Chatvolt ensures uninterrupted conversations across platforms
