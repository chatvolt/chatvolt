...
import config from '@chatvolt/lib/account-config';
      ...
      >
        ...
        {props.plan === 'level_0' && (
          <li className="flex items-center">
            ...
            <Tooltip
              id="06"
              content="Team seats are used to give access to your team members to your Chatvolt account"
              dark={props.highlighted}
            >
        ...
        <li className="flex items-center">
          ...
          <Tooltip
            id="06"
            content="Remove 'Powered by Chatvolt' from all widgets"
            dark={props.highlighted}
          >
            Remove Chatvolt branding
          </Tooltip>
        </li>
  ...
  const faqs = [
    {
      ...
      text: 'Absolutely! Chatvolt allows offers a free with limited features to get started quickly.',
      active: false,
    },
    {
    ...
    {
      title:
        'I need a custom integration or feature that is not supported by Chatvolt. Can you help?',
    ...
    },
    {
      ...
      text: 'You can send us an email at support@chatvolt.ai or use the chat widget on the bottom right of the page.',
      active: false,
    },
  ];
