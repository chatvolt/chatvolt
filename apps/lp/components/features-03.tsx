            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <motion.p
                  ...
                  variants={defaultChildVariants}
                >
                  With Chatvolt you have all the tools you need to engage with
              ...
              <div className="mb-8 space-y-2 md:mb-0">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-zinc-500">
                      {`Handle all your emails through Chatvolt's convenient dashboard. It will assist you in resolving the issue faster.`}
                    </div>
                  </div>
                </motion.button>
                <motion.button
        ...
        >
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-16">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                Chatvolt retrains your AI chatbot automatically when your data
                is updated.
              </p>
            </div>
            {/* Block #3 */}
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                With Chatvolt you can take over the conversation at any time,
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                Founded in Brazil, we respect your privacy. Your data is
